# Plan: 000037_spec_plan_historical_artifacts
...
- **Prior specs and plans** — none. Spec `000037_spec_plan_historical_artifacts` is stand-alone; no upstream spec must land first, and no prior plan gates this work. Spec `000038_artifact_metadata` touches an adjacent concern (metadata on historical artifacts) but is deliberately independent; the two can ship in either order.
