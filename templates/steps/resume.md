...
2. Read `.spektacular/context.md` for the cross-cutting learnings and the answers the user gave to your questions. Its `## Repos` section at the top — regenerated by the CLI on every workflow command — lists each registered repo and where its code lives; that is your map for any code you research, cite, or change from here. Never assume the directory you started in is a repo's code.
