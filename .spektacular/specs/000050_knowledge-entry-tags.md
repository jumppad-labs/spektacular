...
- [ ] **Tags retrieve an entry on their own**
...
- [ ] **A tag match outweighs a body occurrence**
...
- [ ] **Repeated occurrences of a term give diminishing returns**
  A long entry mentioning a term many times does not outrank a short entry that is about that term.

- [ ] **Users can narrow a search to tagged entries**
...
- [ ] **The capture flow proposes tags**
...
- [ ] **Users can audit the tags on existing entries**
...
- [ ] **The ranking design is recorded in the project's knowledge base**
...
- [ ] **An untagged knowledge base needs no migration**
...
- [ ] **A weak match appears alone and disappears in company**
...
- [ ] **Volume does not beat relevance**
...
- [ ] **The tag filter excludes untagged and differently-tagged entries**
...
- [ ] **Capture shows proposed tags before writing**
...
- [ ] **A proposal reuses an existing tag rather than a near-duplicate**
...
- [ ] **An audit writes nothing without confirmation**
  No entry is modified until the user confirms the proposed changes.

- [ ] **A knowledge entry describes how ranking works**
